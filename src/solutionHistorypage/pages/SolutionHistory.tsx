...
const SolutionHistory = () => {
  ...
  const { currentData, currentPage, maxPage, jump } = usePagination<SolvedTask>(
    10,
    solvedTasks
  );
    ...
    <>
      ...
      <div className="solution-wrapper">
        <div className="solution-history">
          {solvedTasks.length < 1 && (
            <p className="solution-history__no-solutions">
              ...
              <table>
                ...
                <tbody>
                  {currentData.map((sol, idx) => {
                    return (
                      <tr key={idx}>
                        <td className="row-place">{sol.taskGeneralInfo?.id}</td>
